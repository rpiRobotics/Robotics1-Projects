...
ALVARMultiMarkerBundle_Red = struct('n_markers', int32(1), 'marker_ids', ...
    int32([56]), 'marker_translations', [0; 0; 0], ...
    'marker_orientations', [1; 0; 0; 0], 'marker_sizes', [0.02]);
ALVARMultiMarkerBundle_Blue = struct('n_markers', int32(1), 'marker_ids', ...
    int32([57]), 'marker_translations', [0; 0; 0], ...
    'marker_orientations', [1; 0; 0; 0], 'marker_sizes', [0.02]);
IP.connectToRobotRaconteurCameraService('tcp://localhost:2355/WebcamServer/Webcam','SimpleWebcam_service.Webcam');
red = IP.addALVARMultiMarkerBundle(ALVARMultiMarkerBundle_Red);
blue = IP.addALVARMultiMarkerBundle(ALVARMultiMarkerBundle_Blue);
