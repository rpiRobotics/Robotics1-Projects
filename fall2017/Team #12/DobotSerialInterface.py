...
class DobotSerialInterface:
    ...
    def __init__(self, port_name=settings.comport, baud_rate=9600):
    ...
    def connect(self, port_name=settings.comport, baud_rate=9600):
    ...
    def _send_command(self, cmd_str_10):
        ...
        self.serial_connection.write(cmd_str)        # print "sending", binascii.b2a_hex(cmd_str)
    ...
    def send_absolute_angles(self, base, rear, front, rot,  move_mode=MOVE_MODE_LINEAR):
        ...
        print "Setting: ", base, rear, front, rot
    ...
    def set_speed(self, VelRat=10, AccRat=10):
        cmd_str_10 = [0]*10
        cmd_str_10[0] = 10
        cmd_str_10[2] = VelRat
        cmd_str_10[3] = AccRat
    ...
    def read_loop(self):
        ...
        while True:
            ...
            while len(self.read_buffer) >= DobotStatusMessage.MESSAGE_LENGTH:
                ...
                # sys.stdout.flush()
                if cnt % 10 == 0:
                    print datetime.datetime.now().strftime("%I:%M:%S"), msg.angles
                cnt += 1