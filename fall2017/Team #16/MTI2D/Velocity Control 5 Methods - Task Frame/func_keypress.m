...
elseif (strcmp(event.Key,'r'))    
    disp('scan distance recorded');
    params.keyboard.rec_flag = 1;
elseif (strcmp(event.Key,'f'))    
    disp('clear scan distance');
    params.keyboard.rec_flag = 0;
elseif (strcmp(event.Key,'p'))
%     params.robot.setJointCommand('right',[0,0,0,0,0,0,0]');
    disp('robot is stopping');
    params.keyboard.pause_flag = 1;
