 ...
 */
image<rgb> *segment_image(image<rgb> *im, float sigma, float c, int min_size, int *num_ccs, std::vector<rect>& region_rects);
// std::pair<image<rgb> *, std::vector<rect> > segment_image(image<rgb> *im, float sigma, float c, int min_size, int *num_ccs);
